...
namespace IronPython.Modules {
    public static class PythonExpat {
        ...
        public static void PerformModuleReload(PythonContext/*!*/ context, PythonDictionary/*!*/ dict) {
            context.EnsureModuleException("pyexpaterror", dict, "ExpatError", "xml.parsers.expat");
        }
        ...
        public static object ParserCreate(object encoding, object namespace_separator, object intern) {
            ...
            var namespace_separator_str = namespace_separator == null ? null : (namespace_separator as string ?? throw PythonOps.TypeError($"ParserCreate() argument 2 must be string or None, not {PythonTypeOps.GetName(encoding)}"));
        ...
        public class xmlparser {
            ...
            public void ParseFile(CodeContext context, object file) {
                ...
                var data = PythonOps.CallWithContext(context, _readMethod) as string;

                if (data == null) throw PythonOps.TypeError("read() did not return a string object");
        ...
        private static Exception Error(CodeContext/*!*/ context, string msg) {
            return PythonExceptions.CreateThrowable((PythonType)context.LanguageContext.GetModuleState("pyexpaterror"), msg);
        }
    }
}
